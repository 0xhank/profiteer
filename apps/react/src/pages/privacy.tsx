...
This "Privacy Notice" describes the privacy practices of and Profiteer Affiliates (collectively, "Profiteer", "our", "us" or "we"), in connection with the Sites and the Profiteer Platform (collectively, "Services"). This Privacy Notice also explains the rights and choices available to individuals with respect to their information.

Please read this Privacy Notice carefully to understand our policies and practices regarding your information. If you do not agree with our policies and practices, please do not use the Profiteer Platform. By accessing or using the Profiteer Platform, you acknowledge and agree to the terms of this Privacy Notice.

We may update this Privacy Notice based upon evolving laws, regulations and industry standards, or as we may make changes to the Profiteer Platform. If we make changes that materially alter your privacy rights, we will take appropriate measures to inform you, consistent with the significance of the changes we make. If you disagree with the changes to this Privacy Notice, you should discontinue your access and use of the Profiteer Platform.

Our Site and the Profiteer Platform are not directed to, and we do not knowingly collect Personal Data from, anyone under the age of 18. If a parent or guardian becomes aware that his or her child has provided us with information, they should contact us. We will delete such information from our files as soon as reasonably practicable.
...
- Transaction information such as the wallet addresses of senders and recipients of Digital Assets, activities on the Profiteer Platform, your inquiries and our responses;
- Usage Data which can include your IP address, your country of origin, the features of the browser or operating system utilised by you, how you use the Profiteer Platform, among other identifiers;
...
We collect this information from you when you freely provide it on the Profiteer Platform or when you use the Profiteer Platform. We may also collect your Personal Data from third parties or publicly available sources as noted above.

Unless specified otherwise, all Personal Data requested by us is mandatory and failure to provide this Personal Data may make it impossible for you to access or use the Profiteer Platform. In cases where the Profiteer Platform specifically states that some Personal Data is not mandatory, users are free not to communicate this Personal Data without consequences to the availability or the functioning of the Profiteer Platform. Users who are uncertain about which Personal Data is mandatory may contact us for clarification.

### Information We Automatically Collect
When you visit the Profiteer Platform, we may automatically collect certain information about your device, including information about your web browser, IP address and/or domain name, IMEI or other device information, your login information, browser type and version, timezone setting, browser plug-in types and versions, operating systems and platforms, location information, and some of the cookies that are installed on your device using cookies and similar technologies. Additionally, as you browse the Site, we may collect information about the individual web pages or services that you view, what websites or search terms referred you to the Site, and information about how you interact with the Site.
...
#### How We Use Cookies
We use Cookies to track how you use the Profiteer Platform by providing usage statistics. Cookies are also used to deliver our information (including updates) and allow account authentication to you based upon your browsing history and previous visits to the Site.
...
The Personal Data processing is carried out using computers and/or IT enabled tools, following organisational procedures and modes strictly related to the purposes indicated. Data may be accessible to you and in some cases, to certain types of persons in charge, involved with the operation of the Profiteer Platform (administration, legal, system administration) or external parties (such as third-party technical service providers, hosting providers, IT companies) appointed, if necessary, as Data Processors by us. You may request a list of these parties at any time.
...
- Provide the Site and Profiteer Platform and customer support you request;
- Process transactions and send notices about your transactions on the Profiteer Platform;
- Detect any malicious or fraudulent activity;
- Enable us to monitor and analyse your behaviour ("Analytics");
- Beta test certain features or the Profiteer Platform;
- Contact you;
- Display content from external platforms;
- Handle productivity related activities;
- Provide social features;
- Optimise traffic and performance of the Profiteer Platform;
- Allow us to register you as a user of the Profiteer Platform and authenticate your credentials;
- Comply with legal obligations and respond to enforcement requests;
- Protect the rights and interests of Profiteer and Profiteer Affiliates (or those of our users and third parties);
- Infrastructure monitoring;
- Interaction with external social networks and platforms;
- Location-based interactions;
- Tag management (tags are pieces of code that allow us to better analyse and track activities on the Profiteer Platform);
- Engage in traffic optimisation and distribution.

### How We Share Personal Data
We may share your Personal Data with our service providers and vendors to assist us in providing you with the Profiteer Platform. We do not share your Personal Data with third parties without your consent, except as described in this Privacy Notice or as otherwise required or permitted by applicable law. We may share your Personal Data within our group, and with affiliates, for purposes consistent with this Privacy Notice.
...
Unfortunately, the transmission of information via the internet is not completely secure. Although we do our best to protect your Personal Data, we cannot guarantee the security of your Personal Data transmitted to the Profiteer Platform. Any transmission of Personal Data is at your own risk.
